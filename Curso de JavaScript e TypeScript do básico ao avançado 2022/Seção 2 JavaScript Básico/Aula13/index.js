...
const nomeSEspaco = nome.replaceAll(" ", "");

document.body.innerHTML += `Seu nome é <strong>${nome}</strong> <br>`;
document.body.innerHTML += `Seu nome tem <strong>${nomeSEspaco.length}</strong> letras <br>`; //preciso me livrar dos espaços
